...
#
# # ---------------------------------------------------------------------------
# # POST /optimize/license  — start optimisation job
# # ---------------------------------------------------------------------------
# @router.get("/license")
...
#             .all()
#         )
#         # Note: normally one summary row per request, but query returns a list
#         # to stay consistent with other endpoints.
#
#         if not rows:
...
#
#         # Returns a list — typically one summary row per request_id
#         return [
#             {
#                 "sim_id":               r.SIM_ID,

...
#     3. Manual (OBJ_STATUS='U') vs system-added distinction
...
#         obj_status  = data["obj_statuses"]
#
#         # If ANY row for this object+field is NOT manually added → treat as system-added
#         is_manual = all(s == "U" for s in obj_status)
#
#         # ---- ACTVT enrichment ----
#         value_descriptions = ""
...
#         else:
#             # System-added — find relevant transaction codes via USOBXC
#             try:
...
# considering auth obj, field, value if not U , then only going for usobx_c. working. the below one is the ehanced version

...
from app.routers import client_sys_release_version, data_loader_router, logs_router, simulator_router, \
    fue_calculation_router, simulator_helpers, ai_config, Optimizer_router
...
app.include_router(client_sys_release_version.router)
app.include_router(fue_calculation_router.router)
app.include_router(simulator_helpers.router)

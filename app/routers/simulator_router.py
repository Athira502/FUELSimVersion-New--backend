...
#     """
#     Calculate FUE summary based on current simulation table state.
#     Mirrors the FUE calculation from Stage 6 dashboard.
#     """
#     logger.info(f"Calculating simulation FUE for system '{system_name}'")
#
#     RoleLicSimModel = create_role_lic_sim_model(system_name)
#
#     # Step 1: Calculate role-level licenses from simulation table
...
#
#     # Step 2: Map to users
#     from app.models.dynamic_models import create_user_lic_model
#     UserRoleLicModel = create_user_lic_model(system_name)
#
#     user_role_mappings = db.query(UserRoleLicModel).all()
#
#     user_licenses = defaultdict(list)
#     for mapping in user_role_mappings:
#         simulated_role_license = role_final_licenses.get(
#             mapping.AGR_NAME,
#             'Not Classified'
#         )
#         user_licenses[mapping.UNAME].append(simulated_role_license)
#
...
#
#     # Calculate FUE
#     gb_count = license_counts['GB Advanced Use']
#     gc_count = license_counts['GC Core Use']
#     gd_count = license_counts['GD Self-Service Use']
#
